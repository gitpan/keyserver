# This Makefile is for the keyserver extension to perl.
#
...
#	EXE_FILES => [q[keyserver]]
#	INSTALLSCRIPT => q[/home/barryp/bin]
#	NAME => q[keyserver]
#	PREREQ_PM => { Net::MySQL=>q[0.08], constant=>q[0], Sys::Hostname=>q[0], IO::Socket=>q[0], Crypt::RSA=>q[1.5], POSIX=>q[0], HTTP::Status=>q[1.26], HTTP::Daemon=>q[1.26] }
#	VERSION => q[1.04]
...
manifypods : pure_all keyserver
	@$(POD2MAN) \
	keyserver \
	$(INST_MAN1DIR)/keyserver.$(MAN1EXT)
...
pure_all :: $(INST_SCRIPT)/keyserver
	@$(NOOP)

realclean ::
	rm -f $(INST_SCRIPT)/keyserver

$(INST_SCRIPT)/keyserver: keyserver Makefile $(INST_SCRIPT)/.exists
	@rm -f $(INST_SCRIPT)/keyserver
	cp keyserver $(INST_SCRIPT)/keyserver
	$(FIXIN) $(INST_SCRIPT)/keyserver
	-@$(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/keyserver
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"keyserver\" VERSION=\"1,04,0,0\">\n}. qq{\t<TITLE>keyserver</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Crypt-RSA\" VERSION=\"1,5,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"HTTP-Daemon\" VERSION=\"1,26,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"HTTP-Status\" VERSION=\"1,26,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"IO-Socket\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Net-MySQL\" VERSION=\"0,08,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"POSIX\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Sys-Hostname\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"constant\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > keyserver.ppd
